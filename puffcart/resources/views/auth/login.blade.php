    ...
    <div class="flex items-center justify-center p-10">
        <div class="bg-[#0a0e1c] border border-[#00ffe730] rounded-sm p-7 w-full max-w-sm relative">
            ...
            <div class="flex bg-[#14172a] rounded-sm p-1 mb-5 border border-[#00ffe718]">
                <span class="flex-1 text-center font-['Orbitron'] text-[9px] py-2 bg-[#00ffe7] text-[#04050d] font-bold rounded-sm tracking-widest cursor-pointer">SIGN_IN</span>
                <a href="{{ route('register') }}" class="flex-1 text-center font-['Orbitron'] text-[9px] py-2 text-[#1e3d52] tracking-widest hover:text-[#5a8fa8]">REGISTER</a>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="user@email.com"
                ...
                <button type="submit"
                        class="w-full font-['Orbitron'] text-[10px] py-3 bg-[#00ffe7] text-[#04050d] font-bold tracking-widest hover:bg-[#00ccb8]"
            ...
            <div class="text-center mt-4 text-[9px] text-[#1e3d52]">
                No account? <a href="{{ route('register') }}" class="text-[#00ffe7] hover:underline">Register →</a>
            </div>
        </div>
    </div>
</div>
