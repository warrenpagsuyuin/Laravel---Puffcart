            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password" placeholder="••••••••"
                           class="w-full bg-[#14172a] border border-[#00ffe718] text-[#c8f0ff] text-[12px] px-3 py-2 rounded-sm outline-none font-mono focus:border-[#00ffe7] @error('password') border-[#ff003c] @enderror">
                </div>
                <div class="mb-4">
